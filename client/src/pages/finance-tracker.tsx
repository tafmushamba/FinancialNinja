          ...
          <Tabs defaultValue="accounts" className="w-full">
                  ...
                  {financeLoading ? (
                    ...
                    <div className="space-y-4">
                      {financeData?.accounts?.map((account) => (
                        <div key={account.id} className="flex justify-between items-center p-4 bg-dark-700 rounded-md">
            ...
            <TabsContent value="transactions" className="mt-4">
              <Card className="bg-dark-800 border-dark-600">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center p-4 bg-dark-700 rounded-md">
                      <div className="flex items-center">
                  ...
                  {insightsLoading ? (
                    ...
                    <div className="space-y-6">
                      {insightsData?.insights?.map((insight, index) => (
                        <div key={index} className="p-4 bg-dark-700 rounded-md">
